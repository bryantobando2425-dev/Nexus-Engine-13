...
export async function suggestFieldValue(payload: { fieldPath: string; currentValue: any; suggestion: string; context: any; aiProvider?: AIProvider }): Promise<{ newValue: any; explanation: string }> {
