...
export async function streamWithProviderResult(
  ...
  if (provider === "anthropic") {
    return anthropicStream(ANTHROPIC_NARRATION_MODEL, userPrompt, systemPrompt, 2048);
  }
  return geminiStreamResult(GEMINI_NARRATION_MODEL, userPrompt, systemPrompt);
}
